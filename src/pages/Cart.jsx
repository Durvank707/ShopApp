                ...
                <div className="flex flex-col max-w-[1200px] mx-auto justify-center">
                    ...
                    <div className="flex flex-col mt-5 w-[100%]">
                        ...
                        <div className="flex flex-col">
                            ...
                            <button className="bg-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl mb-[40px]">CheckOut Now</button>
                        </div>
                    </div>
                </div>
            ) : (
